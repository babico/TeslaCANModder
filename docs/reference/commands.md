...
| `canHealth` | object | Per-bus MCP2515 detection: `{bus0:{on,det}, bus1:{on,det}, bus2:{on,det}}` |

Example response:

```json
{"t":"platform","model":1,"hwGen":3,"swYear":2026,"swWeek":14,"swRelease":1,"fsdProto":3,"swCompat":0,"resolved":1,"canHealth":{"bus0":{"on":1,"det":1},"bus1":{"on":1,"det":1},"bus2":{"on":1,"det":1}}}
```
