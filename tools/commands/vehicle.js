...
const VEHICLE_COMMANDS = {
  // mirrors
  'mirror-fold': 'mirror:fold', 'mirror-unfold': 'mirror:unfold', 'mirror-heat': 'mirror:heat',
  // locks
  'lock': 'lock', 'unlock': 'unlock', 'child-lock': 'lock:child', 'horn': 'horn',
  // trunk
  'frunk-open': 'frunk:open', 'frunk-close': 'frunk:close',
  'trunk-open': 'trunk:open', 'trunk-close': 'trunk:close', 'glovebox': 'glovebox',
  // lights
  'fog-front': 'light:fog:front', 'fog-rear': 'light:fog:rear',
  'dome-on': 'light:dome:on', 'dome-off': 'light:dome:off', 'dome-auto': 'light:dome:auto',
  // wipers
  'wiper-off': 'wiper:off', 'wiper-1': 'wiper:1', 'wiper-2': 'wiper:2', 'wiper-3': 'wiper:3',
  // climate
  ...
  // vent
  'vent-open': 'vent:open', 'vent-close': 'vent:close',
  // power
  'acc-on': 'power:acc:on', 'acc-off': 'power:acc:off', 'power-ready': 'power:ready', 'power-off': 'power:off',
};
