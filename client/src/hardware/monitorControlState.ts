...
export function resolveQuickActionBlockReason(input: QuickActionBlockReasonInput): string | null {
...
export function buildMonitorControlState(input: MonitorControlStateInput): MonitorControlState {
	...
	return {
		...
		canRunSelectedCommand: input.selectedCommandAvailable && input.transportCanExecuteCommands,
