...
import type { MonitorTransportOption, MonitorTransportStatus } from "../../../hardware/transportPresentation";
...
export interface MonitorScreenProps {
  ...
  liveDecodedFeed: Array<{ frameKey: string; idHex: string; frameName: string; signalCount: number }>;
