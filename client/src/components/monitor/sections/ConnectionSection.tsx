...
export function ConnectionSection(props: MonitorScreenProps) {
	...
	const [runnerCommand, setRunnerCommand] = useState<string>(
		props.availableCommands[0] ?? "status",
	);
	...
	const runCommandFromMonitor = async () => {
		...
		try {
			...
			setRunnerFeedback(
				`Executed ${commandName}${runnerArgs.trim() ? ` with args ${runnerArgs.trim()}` : ""}.`,
			);
		} catch (error) {
	...
	return (
		<View style={styles.section}>
			...
			<View style={styles.metaRow}>
				<StatusPill
					label="Transport"
					value={props.transportStatus.title}
					ready={props.transportStatus.tone === "ready"}
				/>
			...
			<View style={[styles.grid, isWide ? styles.gridWide : undefined]}>
				<View style={styles.col}>
					<View style={styles.card}>
						...
						<View
							style={[
								styles.statusCard,
								props.transportStatus.tone === "ready"
									? styles.statusReady
						...
						<ActionButton
							title="Fetch Status"
							onPress={() => void props.onFetchStatus()}
							disabled={runnerBusy}
						/>
					</View>
					...
					<View style={styles.card}>
						...
						<View style={styles.buttonRow}>
							<ActionButton
								title={props.bleConfigBusy ? "Reading" : "Read BLE Status"}
								variant="secondary"
								onPress={() => void props.onRefreshBleStatus()}
								disabled={props.bleConfigBusy}
							/>
							<ActionButton
								title={props.bleConfigBusy ? "Applying" : "Apply BLE Name"}
								onPress={() => void props.onApplyBleDeviceName()}
								disabled={props.bleConfigBusy || !props.bleDeviceName.trim()}
							/>
						</View>
					</View>
				</View>
				...
				<View style={styles.col}>
					<View style={styles.card}>
						...
						<View style={styles.buttonRow}>
							<ActionButton
								title={runnerBusy ? "Executing" : "Execute"}
								onPress={() => void runCommandFromMonitor()}
								disabled={runnerBusy}
							/>
							<ActionButton
								title="Clear"
	...
	return (
		<View style={styles.section}>
			...
			<Text style={styles.subtitle}>
				MQTT, Tesla BLE, Home Assistant, ESP-NOW, GVRET, ScanMyTesla, ELM327
			</Text>
				...
				<View style={styles.card}>
					...
					<View style={styles.buttonRowWrap}>
						<ActionButton
							title="Set Broker"
							variant="secondary"
							onPress={() => void run(`mqtt:broker:${mqttBroker.trim()}`)}
							disabled={isBusy || !mqttBroker.trim()}
							compact
						/>
						<TextInput
						...
						<ActionButton
							title="Set Port"
							variant="secondary"
							onPress={() => void run(`mqtt:port:${mqttPort.trim()}`)}
							disabled={isBusy || !mqttPort.trim()}
							compact
						/>
					</View>
					<View style={styles.buttonRowWrap}>
						...
						<ActionButton
							title="Set Interval"
							variant="secondary"
							onPress={() => void run(`mqtt:interval:${mqttInterval.trim()}`)}
							disabled={isBusy || !mqttInterval.trim()}
							compact
						/>
					</View>
				</View>
				...
				<View style={styles.card}>
					...
					<View style={styles.buttonRowWrap}>
						...
						<ActionButton
							title="Auth"
							variant="secondary"
							onPress={() => void run("teslable:auth")}
							disabled={isBusy}
							compact
						/>
						<ActionButton
							title="Forget"
							variant="secondary"
							onPress={() => void run("teslable:forget")}
							disabled={isBusy}
							compact
						/>
					</View>
				...
				<View style={styles.card}>
					...
					<View style={styles.buttonRowWrap}>
						...
						<ActionButton
							title="Set Interval"
							variant="secondary"
							onPress={() => void run(`ha:interval:${haInterval.trim()}`)}
							disabled={isBusy || !haInterval.trim()}
							compact
						/>
					</View>
				</View>
				...
				<View style={styles.card}>
					...
					<View style={styles.buttonRowWrap}>
						...
						<ActionButton
							title="Set Channel"
							variant="secondary"
							onPress={() => void run(`espnow:channel:${espNowChannel.trim()}`)}
							disabled={isBusy || !espNowChannel.trim()}
							compact
						/>
					</View>
				</View>
				...
				<View style={styles.card}>
					...
					<View style={styles.buttonRowWrap}>
						...
						<ActionButton
							title="Set Port"
							variant="secondary"
							onPress={() => void run(`gvret:port:${gvretPort.trim()}`)}
							disabled={isBusy || !gvretPort.trim()}
							compact
						/>
					</View>
				</View>
				...
				<View style={styles.card}>
					...
					<View style={styles.buttonRowWrap}>
						...
						<ActionButton
							title="SMT Off"
							variant="secondary"
							onPress={() => void run("smt:off")}
							disabled={isBusy}
							compact
						/>
						<ActionButton
							title="ELM On"
							onPress={() => void run("elm327:on")}
							disabled={isBusy}
							compact
						/>
						<ActionButton
