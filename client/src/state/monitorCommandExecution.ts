 ...
 */
export function resolveCommandExecutionReadiness(input: ResolveCommandExecutionInput): {
	canExecute: boolean;
	blockReason?: string;
} {
 ...
 */
export function buildQuickActionResult(input: BuildQuickActionResultInput): CommandExecutionResult {
