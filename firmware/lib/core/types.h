...
{
	return m == NAG_MODE_LEGACY || m == NAG_MODE_SAFE || m == NAG_MODE_NATURAL ||
		   m == NAG_MODE_ORGANIC || m == NAG_MODE_FULL;
}
...
{
	return m == NAG_MODE_SAFE || m == NAG_MODE_NATURAL || m == NAG_MODE_ORGANIC ||
		   m == NAG_MODE_FULL;
}
...
struct State
{
	...
	State()
		: variant(HW4), fsdEnabled(false), fsdForceEnabled(false), speedProfile(1),
		  ...
		  nagMode(NAG_MODE_OFF), nagOrganicDriverBypass(false), dasHandsOnState(0), dasApState(0),
		  dasSeen(false), naturalNagLastMs(0), naturalNagIntervalMs(200),
		  nagOrganicRealHandsOn(0), nagOrganicPrevState(0xFF), nagOrg1EnterMs(0), nagOrg1HoldRaw(2048),
		  nagOrg1HoldLevel(0), nagOrg2EnterMs(0), nagOrg2WalkRaw(2048), nagOrg2HoldUntilMs(0),
		  ...
		  alcAutoConfirmEnabled(false), dasLaneChangeState(0),
		  ...
		  apFirstEnabled(false), assistNavEnable(false), assistHandsOff(false), assistDevMode(false),
