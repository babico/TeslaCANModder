...
void test_power_acc_on() { State s = makeState(); TEST_ASSERT_TRUE(execPowerCmd("power:acc:on", s)); }
void test_power_acc_off() { State s = makeState(); TEST_ASSERT_TRUE(execPowerCmd("power:acc:off", s)); }
void test_power_ready() { State s = makeState(); TEST_ASSERT_TRUE(execPowerCmd("power:ready", s)); }
void test_power_off() { State s = makeState(); TEST_ASSERT_TRUE(execPowerCmd("power:off", s)); }
