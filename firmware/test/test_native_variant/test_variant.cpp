...
void setUp()    { saveCount = 0; filterCount = 0; }
void tearDown() {}
...
void test_hw4_fsd_enabled()       { TEST_ASSERT_TRUE(getFeatures(HW4).fsd); }
void test_hw4_fsdForce_enabled()  { TEST_ASSERT_TRUE(getFeatures(HW4).fsdForce); }
void test_hw4_offset_enabled()    { TEST_ASSERT_TRUE(getFeatures(HW4).offset); }
void test_hw4_profile_enabled()   { TEST_ASSERT_TRUE(getFeatures(HW4).profile); }
void test_hw4_nag_enabled()       { TEST_ASSERT_TRUE(getFeatures(HW4).nag); }
void test_hw4_isaChime_enabled()  { TEST_ASSERT_TRUE(getFeatures(HW4).isaChime); }
void test_hw4_summon_enabled()    { TEST_ASSERT_TRUE(getFeatures(HW4).summon); }

// ── HW3 ──────────────────────────────────────────────────────────────────────

void test_hw3_fsd_enabled()       { TEST_ASSERT_TRUE(getFeatures(HW3).fsd); }
void test_hw3_fsdForce_enabled()  { TEST_ASSERT_TRUE(getFeatures(HW3).fsdForce); }
void test_hw3_offset_enabled()    { TEST_ASSERT_TRUE(getFeatures(HW3).offset); }
void test_hw3_profile_enabled()   { TEST_ASSERT_TRUE(getFeatures(HW3).profile); }
void test_hw3_nag_enabled()       { TEST_ASSERT_TRUE(getFeatures(HW3).nag); }
void test_hw3_isaChime_disabled() { TEST_ASSERT_FALSE(getFeatures(HW3).isaChime); }
void test_hw3_summon_enabled()    { TEST_ASSERT_TRUE(getFeatures(HW3).summon); }

// ── Legacy ───────────────────────────────────────────────────────────────────

void test_legacy_fsd_enabled()        { TEST_ASSERT_TRUE(getFeatures(LEGACY).fsd); }
void test_legacy_fsdForce_enabled()   { TEST_ASSERT_TRUE(getFeatures(LEGACY).fsdForce); }
void test_legacy_offset_disabled()    { TEST_ASSERT_FALSE(getFeatures(LEGACY).offset); }
void test_legacy_profile_enabled()    { TEST_ASSERT_TRUE(getFeatures(LEGACY).profile); }
void test_legacy_nag_enabled()        { TEST_ASSERT_TRUE(getFeatures(LEGACY).nag); }
void test_legacy_isaChime_disabled()  { TEST_ASSERT_FALSE(getFeatures(LEGACY).isaChime); }
void test_legacy_summon_disabled()    { TEST_ASSERT_FALSE(getFeatures(LEGACY).summon); }
