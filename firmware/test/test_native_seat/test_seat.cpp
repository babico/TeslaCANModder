...
void test_seat_fl() { State s = makeState(); TEST_ASSERT_TRUE(execSeatCmd("seat:fl:2", s)); }
void test_seat_fr() { State s = makeState(); TEST_ASSERT_TRUE(execSeatCmd("seat:fr:0", s)); }
void test_seat_rl() { State s = makeState(); TEST_ASSERT_TRUE(execSeatCmd("seat:rl:1", s)); }
void test_seat_rr() { State s = makeState(); TEST_ASSERT_TRUE(execSeatCmd("seat:rr:3", s)); }
void test_seat_rc() { State s = makeState(); TEST_ASSERT_TRUE(execSeatCmd("seat:rc:1", s)); }
