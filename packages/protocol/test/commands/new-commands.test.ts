...
describe('new commands', () => {
  describe('Drive Mode', () => {
    ...
    it('driveModeStandard', () => expect(commands.driveModeStandard()).toBe('drivemode:standard'));
    it('driveModePerformance', () => expect(commands.driveModePerformance()).toBe('drivemode:performance'));
  });
  ...
  describe('Button Remapping', () => {
    it('btnMap lamp short trunk', () => expect(commands.btnMap('lamp', 'short', 'trunk')).toBe('btnmap:lamp:short:trunk'));
    it('btnMap parking long sentry', () => expect(commands.btnMap('parking', 'long', 'sentry')).toBe('btnmap:parking:long:sentry'));
    it('btnMap lamp double horn', () => expect(commands.btnMap('lamp', 'double', 'horn')).toBe('btnmap:lamp:double:horn'));
    it('btnMapQuery', () => expect(commands.btnMapQuery()).toBe('btnmap:query'));
    it('btnMapReset', () => expect(commands.btnMapReset()).toBe('btnmap:reset'));
    it('rejects invalid button', () => expect(() => commands.btnMap('invalid' as never, 'short', 'trunk')).toThrow());
    it('rejects invalid press', () => expect(() => commands.btnMap('lamp', 'triple' as never, 'trunk')).toThrow());
    it('rejects invalid action', () => expect(() => commands.btnMap('lamp', 'short', 'fly' as never)).toThrow());
  });
