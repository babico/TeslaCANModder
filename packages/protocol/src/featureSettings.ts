...
export type FeatureSettingControlType = "toggle" | "enum" | "number" | "text" | "action" | "query";
...
const FEATURE_SETTINGS_BY_ID_INTERNAL = {
		...
		settings: [
			{
				...
				control: "toggle",
				commandNames: ["banShield"],
			},
			{
				id: "gtwShieldArm",
				label: "GTW Shield Arm",
				control: "action",
				commandNames: ["gtwShieldArm"],
			},
			{
				id: "gtwShieldDisarm",
				label: "GTW Shield Disarm",
				control: "action",
				commandNames: ["gtwShieldDisarm"],
			},
			{
				id: "gtwShieldReset",
				label: "GTW Shield Reset",
				control: "action",
				commandNames: ["gtwShieldReset"],
			},
		],
	},
	apGate: {
		...
		settings: [
			{
				id: "apGateEnabled",
				label: "Enable AP Gate",
				control: "toggle",
				commandNames: ["apGate"],
			},
			{
				id: "apGateStatus",
				label: "Query AP Gate Status",
				control: "query",
				commandNames: ["apGateStatus"],
			},
		],
	},
	bmsTelemetry: {
	...
	canClock: {
		...
		settings: [
			{
				...
				label: "Clock Mode",
				control: "enum",
				commandNames: ["canClockAuto", "canClock"],
				options: [
					{
						value: "auto",
						label: "Auto",
		...
		notes: ["12 MHz is accepted as compatibility mode in firmware."],
	},
	rawCan: {
		featureId: "rawCan",
		...
		settings: [
			{
				...
				control: "action",
				commandNames: ["canSimStart"],
			},
			{
				id: "canSimStop",
				label: "Stop Simulator",
				control: "action",
				commandNames: ["canSimStop"],
			},
		],
	},
	chargeControl: {
		...
		settings: [
			{
				...
				control: "action",
				commandNames: ["chargeStart"],
			},
			{
				id: "chargeStop",
				label: "Stop Charging",
				control: "action",
				commandNames: ["chargeStop"],
			},
			{
				id: "chargePort",
				label: "Toggle Charge Port",
				control: "action",
				commandNames: ["chargePort"],
			},
		],
	},
	climate: {
		...
		settings: [
			{
				...
				control: "action",
				commandNames: ["climateKeep"],
			},
			{
				id: "climateOff",
				label: "Turn Climate Off",
				control: "action",
				commandNames: ["climateOff"],
			},
		],
	},
	displayBrightness: {
		...
		settings: [
			{
				...
				control: "number",
				commandNames: ["mainDisplay"],
				min: 0,
				max: 127,
				step: 1,
			},
		],
		notes: ["Requires hasCtrl in firmware runtime."],
	},
	driveContext: {
		...
		kind: "internal",
		settings: [],
		notes: ["No command handler; provides internal runtime context only."],
	},
	driveMode: {
		featureId: "driveMode",
		...
		settings: [
			{
				...
				control: "toggle",
				commandNames: ["isaChime"],
			},
		],
		notes: ["Feature is HW4-only in firmware."],
	},
	lights: {
		featureId: "lights",
		title: "Lighting",
		...
		settings: [
			{
				...
				label: "Lock Action",
				control: "enum",
				commandNames: ["lock", "unlock", "lockChild", "horn"],
				options: [
					{
						value: "lock",
						label: "Lock",
	...
	speedOffset: {
		...
		settings: [
			...
			},
			{
				...
				label: "Offset Auto",
				control: "action",
				commandNames: ["offsetAuto"],
			},
			{
				id: "offsetOff",
				label: "Offset Off",
				control: "action",
				commandNames: ["offsetOff"],
			},
		],
		notes: ["Firmware constrains max offset by hardware variant at runtime."],
	},
	pedalMode: {
		featureId: "pedalMode",
		title: "Pedal Mode",
		...
		settings: [
			{
				...
				control: "enum",
				commandNames: ["pedalStandard", "pedalChill", "pedalSport"],
				options: [
					{
						value: "standard",
						label: "Standard",
		...
		settings: [
			{
				...
				label: "Power Action",
				control: "enum",
				commandNames: ["powerAccOn", "powerAccOff", "powerReady", "powerOff"],
				options: [
					{
						value: "accOn",
						label: "ACC On",
	...
	speedProfile: {
		...
		settings: [
			...
			},
			{
				...
				label: "Override Mode",
				control: "enum",
				commandNames: ["profileAuto", "profileLock", "profileUnlock"],
				options: [
					{
						value: "auto",
						label: "Auto",
		...
		notes: ["Firmware also accepts profile aliases via sp:."],
	},
	regenMode: {
		featureId: "regenMode",
		...
		settings: [
			{
				...
				label: "Regeneration",
				control: "enum",
				commandNames: ["regenOff", "regenLow", "regenStd", "regenMax"],
				options: [
					{
						value: "off",
						label: "Off",
		...
		notes: ["Firmware accepts regen:standard alias in addition to regen:std."],
	},
	regionCodec: {
		...
		kind: "internal",
		settings: [],
		notes: ["No direct command handler in this header; mapping helper only."],
	},
	regionSpoof: {
		...
		notes: ["Spoof region detection to bypass region-locked features. Use with caution."],
	},
	alc: {
		featureId: "alc",
		...
		settings: [
			{
				...
				label: "Sentry Mode",
				control: "toggle",
				commandNames: ["sentryOn", "sentryOff"],
		...
		settings: [
			{
				...
				label: "Stop Behavior",
				control: "enum",
				commandNames: ["stopCreep", "stopRoll", "stopHold"],
				options: [
					{
						value: "creep",
						label: "Creep",
	...
	summon: {
		...
		settings: [
			{
				...
				control: "toggle",
				commandNames: ["summonInject"],
			},
			{
				id: "summonDirection",
				label: "Summon Direction",
				control: "enum",
				commandNames: ["summon", "summonForward", "summonReverse", "summonStop"],
				options: [
					{
						value: "start",
		...
		notes: ["Firmware gate requires summonInject and hasCtrl for active movement."],
	},
	tlsscRestore: {
		...
		settings: [
			{
				...
				label: "Track Mode",
				control: "toggle",
				commandNames: ["trackMode"],
			},
		],
		notes: ["Legacy variant rejects track mode commands in firmware."],
	},
	trunkFrunk: {
		...
		settings: [
			{
				...
				control: "enum",
				commandNames: ["frunkOpen", "frunkClose", "trunkOpen", "trunkClose", "glovebox"],
				options: [
					{
						value: "frunkOpen",
						label: "Open Frunk",
		...
		settings: [
			{
				...
				label: "Signal Action",
				control: "enum",
				commandNames: ["turnLeft3", "turnRight3", "turnHazard", "turnOff"],
				options: [
					{
						value: "left3",
						label: "Left 3-blink",
	...
	windowVent: {
		...
		settings: [
			{
				...
				label: "Vent Preset",
				control: "enum",
				commandNames: ["windowVentOpen", "windowVentClose", "ventOpen", "ventClose"],
				options: [
					{
						value: "open",
						label: "Open",
		...
		notes: ["Legacy variant rejects window vent commands in firmware."],
	},
	wiper: {
		featureId: "wiper",
		title: "Wiper",
		...
		settings: [
			{
				...
				label: "Wiper Speed",
				control: "enum",
				commandNames: ["wiperOff", "wiper1", "wiper2", "wiper3"],
				options: [
					{
						value: "off",
						label: "Off",
