...
export const BUS_NAMES = ['Chassis', 'Vehicle', 'Body'];
...
function applyBoot(prev: BoardState, msg: BootMessage): BoardState {
  ...
  return {
    ...
    turnSignalLeft: msg.turnSignalLeft !== undefined ? Boolean(msg.turnSignalLeft) : prev.turnSignalLeft,
    turnSignalRight: msg.turnSignalRight !== undefined ? Boolean(msg.turnSignalRight) : prev.turnSignalRight,
    bsmLeftLevel: msg.bsmLeftLevel !== undefined ? Number(msg.bsmLeftLevel) : prev.bsmLeftLevel,
    bsmRightLevel: msg.bsmRightLevel !== undefined ? Number(msg.bsmRightLevel) : prev.bsmRightLevel,
    doorFrontLeftOpen: msg.doorFrontLeftOpen !== undefined ? Boolean(msg.doorFrontLeftOpen) : prev.doorFrontLeftOpen,
    doorFrontRightOpen: msg.doorFrontRightOpen !== undefined ? Boolean(msg.doorFrontRightOpen) : prev.doorFrontRightOpen,
    doorRearLeftOpen: msg.doorRearLeftOpen !== undefined ? Boolean(msg.doorRearLeftOpen) : prev.doorRearLeftOpen,
    doorRearRightOpen: msg.doorRearRightOpen !== undefined ? Boolean(msg.doorRearRightOpen) : prev.doorRearRightOpen,
    driverDoorOpen: msg.driverDoorOpen !== undefined ? Boolean(msg.driverDoorOpen) : prev.driverDoorOpen,
    ...
    cruiseSetSpeedKph: msg.cruiseSetSpeed !== undefined ? Number(msg.cruiseSetSpeed) / 10 : prev.cruiseSetSpeedKph,
    accSpeedLimitKph: msg.accSpeedLimit !== undefined ? Number(msg.accSpeedLimit) / 10 : prev.accSpeedLimitKph,
    mapSpeedLimitKph: msg.mapSpeedLimit !== undefined ? Number(msg.mapSpeedLimit) / 10 : prev.mapSpeedLimitKph,
    ...
    variantAutoDetect: msg.variantAutoDetect !== undefined ? Boolean(msg.variantAutoDetect) : prev.variantAutoDetect,
    gtwAutopilotTier: msg.gtwAutopilotTier !== undefined ? Number(msg.gtwAutopilotTier) : prev.gtwAutopilotTier,
    canClockReqMHz: msg.canClockReqMHz !== undefined ? Number(msg.canClockReqMHz) : prev.canClockReqMHz,
    ...
    banDetectCount: msg.banDetectCount !== undefined ? Number(msg.banDetectCount) : prev.banDetectCount,
    gtwShieldArmed: msg.gtwShieldArmed !== undefined ? Boolean(msg.gtwShieldArmed) : prev.gtwShieldArmed,
    gtwShieldBlocks: msg.gtwShieldBlocks !== undefined ? Number(msg.gtwShieldBlocks) : prev.gtwShieldBlocks,
    ...
    alcAutoConfirm: msg.alcAutoConfirm !== undefined ? Boolean(msg.alcAutoConfirm) : prev.alcAutoConfirm,
    dasLaneChangeState: msg.dasLaneChangeState ?? prev.dasLaneChangeState,
    seatbeltEmulation: msg.seatbeltEmulation !== undefined ? Boolean(msg.seatbeltEmulation) : prev.seatbeltEmulation,
    wiperPersist: msg.wiperPersist !== undefined ? Boolean(msg.wiperPersist) : prev.wiperPersist,
    mirrorAutoFold: msg.mirrorAutoFold !== undefined ? Boolean(msg.mirrorAutoFold) : prev.mirrorAutoFold,
    canSim: msg.canSim !== undefined ? Boolean(msg.canSim) : prev.canSim,
    hasPowertrain: msg.hasPowertrain !== undefined ? Boolean(msg.hasPowertrain) : prev.hasPowertrain,
    ...
    teslaBleConnected: msg.teslaBleConnected !== undefined ? Boolean(msg.teslaBleConnected) : prev.teslaBleConnected,
    teslaBleAuth: msg.teslaBleAuth !== undefined ? Boolean(msg.teslaBleAuth) : prev.teslaBleAuth,
    homeAssistant: msg.homeAssistant !== undefined ? Boolean(msg.homeAssistant) : prev.homeAssistant,
    ...
    hasFwVersion: msg.hasFwVersion !== undefined ? Boolean(msg.hasFwVersion) : prev.hasFwVersion,
    mqtt: msg.mqtt !== undefined ? Boolean(msg.mqtt) : prev.mqtt,
    mqttConnected: msg.mqttConnected !== undefined ? Boolean(msg.mqttConnected) : prev.mqttConnected,
    vehicleModel: msg.vehicleModel ?? prev.vehicleModel,
    vehicleYear: msg.vehicleYear ?? prev.vehicleYear,
    hasVehicleConfig: msg.hasVehicleConfig !== undefined ? Boolean(msg.hasVehicleConfig) : prev.hasVehicleConfig,
    platformModel: msg.platformModel ?? prev.platformModel,
    platformHwGen: msg.platformHwGen ?? prev.platformHwGen,
    platformSwYear: msg.platformSwYear ?? prev.platformSwYear,
    platformSwWeek: msg.platformSwWeek ?? prev.platformSwWeek,
    platformSwRelease: msg.platformSwRelease ?? prev.platformSwRelease,
    platformFsdProto: msg.platformFsdProto ?? prev.platformFsdProto,
    platformSwCompat: msg.platformSwCompat ?? prev.platformSwCompat,
    platformResolved: msg.platformResolved !== undefined ? Boolean(msg.platformResolved) : prev.platformResolved,
    canHealth: msg.canHealth ? Object.fromEntries(
      Object.entries(msg.canHealth).map(([k, v]) => [k, { on: Boolean(v.on), det: Boolean(v.det) }])
    ) : prev.canHealth,
    bmsNominalFullPack: msg.bmsNomFullPack !== undefined ? Number(msg.bmsNomFullPack) / 100 : prev.bmsNominalFullPack,
    bmsNominalRemaining: msg.bmsNomRemain !== undefined ? Number(msg.bmsNomRemain) / 100 : prev.bmsNominalRemaining,
    bmsIdealRemaining: msg.bmsIdealRemain !== undefined ? Number(msg.bmsIdealRemain) / 100 : prev.bmsIdealRemaining,
    bmsCellVoltageMax: msg.bmsCellVMax !== undefined ? Number(msg.bmsCellVMax) / 1000 : prev.bmsCellVoltageMax,
    bmsCellVoltageMin: msg.bmsCellVMin !== undefined ? Number(msg.bmsCellVMin) / 1000 : prev.bmsCellVoltageMin,
    bmsMaxRegenPower: msg.bmsMaxRegen !== undefined ? Number(msg.bmsMaxRegen) / 100 : prev.bmsMaxRegenPower,
    bmsMaxDischargePower: msg.bmsMaxDischarge !== undefined ? Number(msg.bmsMaxDischarge) / 100 : prev.bmsMaxDischargePower,
    hasEnhancedBms: msg.hasEnhancedBms !== undefined ? Boolean(msg.hasEnhancedBms) : prev.hasEnhancedBms,
    steeringMode: msg.steeringMode !== undefined ? Number(msg.steeringMode) : prev.steeringMode,
    hasSteeringMode: msg.hasSteeringMode !== undefined ? Boolean(msg.hasSteeringMode) : prev.hasSteeringMode,
    chassisOnline: msg.chassisOnline !== undefined ? Boolean(msg.chassisOnline) : prev.chassisOnline,
    standby: msg.standby !== undefined ? Boolean(msg.standby) : prev.standby,
    vehicleOnline: msg.vehicleOnline !== undefined ? Boolean(msg.vehicleOnline) : prev.vehicleOnline,
...
function applyBms(prev: BoardState, msg: BmsMessage): BoardState {
  return {
    ...
    bmsNominalRemaining: msg.nomRemain !== undefined ? msg.nomRemain / 100 : prev.bmsNominalRemaining,
    bmsIdealRemaining: msg.idealRemain !== undefined ? msg.idealRemain / 100 : prev.bmsIdealRemaining,
    bmsCellVoltageMax: msg.cellVMax !== undefined ? msg.cellVMax / 1000 : prev.bmsCellVoltageMax,
    bmsCellVoltageMin: msg.cellVMin !== undefined ? msg.cellVMin / 1000 : prev.bmsCellVoltageMin,
    bmsMaxRegenPower: msg.maxRegen !== undefined ? msg.maxRegen / 100 : prev.bmsMaxRegenPower,
    bmsMaxDischargePower: msg.maxDischarge !== undefined ? msg.maxDischarge / 100 : prev.bmsMaxDischargePower,
    ...
    bmsInitialFullPack: msg.initFull !== undefined ? msg.initFull / 10 : prev.bmsInitialFullPack,
    ...
    bmsRatedConsumption: msg.ratedCons !== undefined ? msg.ratedCons / 10 : prev.bmsRatedConsumption,
    bmsActualSocInt: msg.actSoc ?? prev.bmsActualSocInt,
    bmsUsableSocInt: msg.useSoc ?? prev.bmsUsableSocInt,
    bmsPowerDissipation: msg.pwrDiss !== undefined ? msg.pwrDiss / 100 : prev.bmsPowerDissipation,
    ...
    bmsStationaryHeatPower: msg.heatPwr !== undefined ? msg.heatPwr / 100 : prev.bmsStationaryHeatPower,
    bmsHvacPowerBudget: msg.hvacBgt !== undefined ? msg.hvacBgt / 100 : prev.bmsHvacPowerBudget,
    bmsPrecondAllowed: msg.precondOk !== undefined ? Boolean(msg.precondOk) : prev.bmsPrecondAllowed,
    bmsHeatingWorthwhile: msg.heatWorth !== undefined ? Boolean(msg.heatWorth) : prev.bmsHeatingWorthwhile,
    ...
    bmsMaxChargeCurrent: msg.maxChgA !== undefined ? msg.maxChgA / 10 : prev.bmsMaxChargeCurrent,
    bmsMaxDischargeCurrent: msg.maxDchA !== undefined ? msg.maxDchA / 10 : prev.bmsMaxDischargeCurrent,
    bmsExpectedRemaining: msg.expRemain !== undefined ? msg.expRemain / 100 : prev.bmsExpectedRemaining,
    ...
    bmsChargeTimeToFull: msg.chgTime !== undefined ? msg.chgTime / 100 : prev.bmsChargeTimeToFull,
  };
}
