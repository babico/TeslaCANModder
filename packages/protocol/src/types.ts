...
export interface BootMessage {
	...
	doorFrontLeftOpen?: WireBool;
	doorFrontRightOpen?: WireBool;
	doorRearLeftOpen?: WireBool;
	doorRearRightOpen?: WireBool;
	driverDoorOpen?: WireBool;
	anyDoorOpen?: WireBool;
	frunkOpen?: WireBool;
	trunkOpen?: WireBool;
	...
	hasEnhancedBms?: WireBool;
	steeringMode?: number;
	hasSteeringMode?: WireBool;
	driveMode?: number;
	...
	alcAutoConfirm?: WireBool;
	dasLaneChangeState?: number;
	seatbeltEmulation?: WireBool;
	apFirst?: WireBool;
	dasApState?: number;
	assistHandsOff?: WireBool;
	wiperPersist?: WireBool;
	mirrorAutoFold?: WireBool;
	canSim?: WireBool;
	hasPowertrain?: WireBool;
	singleShot?: WireBool;
	fwYear?: number;
	fwRelease?: number;
	fwMinor?: number;
	fwBuild?: number;
	fwCompat?: number;
	hasFwVersion?: WireBool;
	mqtt?: WireBool;
	mqttConnected?: WireBool;
	vehicleModel?: number;
	vehicleYear?: number;
	hasVehicleConfig?: WireBool;
	...
	scanMyTesla?: WireBool;
	// ELM327 emulation
	elm327?: WireBool;
	// Tesla BLE Vehicle Control (4.4)
	teslaBle?: WireBool;
	teslaBleConnected?: WireBool;
	teslaBleAuth?: WireBool;
	// Home Assistant / ESPHome (4.5)
	homeAssistant?: WireBool;
	haConnected?: WireBool;
	haEntities?: number;
	haInterval?: number;
